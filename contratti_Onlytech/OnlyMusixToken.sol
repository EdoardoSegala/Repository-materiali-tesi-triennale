 ...
 */
contract OnlyMusixToken is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
  using Strings for string;

  address proxyRegistryAddress;
  address omTradeContract;
  ...
  event Create(address _initialOwner, uint _initialSupply, uint256 _tokenId);
  ...
  function create(
    ...
    emit Create(_initialOwner, _initialSupply, _id);
  ...
  function safeTransferFromTest(address _from, address _to, uint256 _id, uint256 _amount, bytes memory _data) public onlyOwner {
